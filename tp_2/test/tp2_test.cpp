...
TEST_CASE("TP2_Nuage::BarycentrePolaire_V1")
{
    ...
    REQUIRE(b3.getAngle() == Approx((p1.getAngle() + p2.getAngle() + p3.getAngle() + p4.getAngle()) / 4));

    REQUIRE(b3.getDistance() == Approx((p1.getDistance() + p2.getDistance() + p3.getDistance() + p4.getDistance()) / 4));
}
